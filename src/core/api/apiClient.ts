...
if (!API_URL || !API_KEY || !STORE_HASH || !DOMAIN) {
    throw new Error("Missing required environment variables for API configuration. Please check your .env file.");
}
...
export const API_CONFIG = {
    ...
    DOMAIN: DOMAIN,
    LOCALE: LOCALE, // Match Flutter's defaultLocale
};
