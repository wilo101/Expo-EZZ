...
// 1. Wrapped in memo to prevent re-renders when parent updates but product is unchanged
// 2. Removed console.logs from render path
// 3. Removed manual Image.prefetch (expo-image handles caching)
